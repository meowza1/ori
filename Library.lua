...
-- Library init
    getgenv().Library = {
        ...
        TweeningSpeed = 0.25,
        Mobile = {
            Enabled = InputService.TouchEnabled,
            MinimumTouchSize = 36,
            MinimumTextSize = 14
        }
    }
...
-- Library functions 
    -- Misc functions
        ...
        function Library:ClampToViewport(Object, Padding)
            if not (Object and Object:IsA("GuiObject")) then
                return
            end

            local pad = Padding or 4
            local TopInset = GuiService:GetGuiInset().Y
            local Viewport = Camera.ViewportSize

            Object.Position = dim2(
                0,
                math.clamp(Object.Position.X.Offset, pad, math.max(pad, Viewport.X - Object.Size.X.Offset - pad)),
                0,
                math.clamp(Object.Position.Y.Offset, TopInset + pad, math.max(TopInset + pad, Viewport.Y - Object.Size.Y.Offset - pad))
            )
        end

        function Library:ApplyMobileSupport(Object)
            if not (Library.Mobile.Enabled and Object) then
                return
            end
            ...
            if Object:IsA("GuiButton") or Object:IsA("TextBox") then
                ...
                Object.Size = dim2(
                    Object.Size.X.Scale,
                    math.max(Object.Size.X.Offset, Library.Mobile.MinimumTouchSize),
                    Object.Size.Y.Scale,
                    math.max(Object.Size.Y.Offset, Library.Mobile.MinimumTouchSize)
                )
            end

            if (Object:IsA("TextLabel") or Object:IsA("TextButton") or Object:IsA("TextBox")) and Object.TextSize < Library.Mobile.MinimumTextSize then
                Object.TextSize = Library.Mobile.MinimumTextSize
            end

            if Object:IsA("ScrollingFrame") then
                Object.ScrollBarThickness = math.max(Object.ScrollBarThickness, 8)
            end
        end
        ...
        function Library:Create(instance, options)
            ...
            Library:ApplyMobileSupport(ins)
    ...
    -- Library element functions
        function Library:Window(properties)
            ...
            Library.Items = Library:Create( "ScreenGui" , {
                ...
                IgnoreGuiInset = not Library.Mobile.Enabled;
            });
            ...
            local Items = Cfg.Items; do
                -- Window
                    ...
                    Library:ClampToViewport(Items.Window, 8)
